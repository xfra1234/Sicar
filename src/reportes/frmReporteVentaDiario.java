...
import Metodos.MetodosReporteVentaDiario;
 ...
 * @author usuario
 */
public class frmReporteVentaDiario extends javax.swing.JFrame {

    /**
     * Creates new form frmReporteDepartamento
     */
    Metodos.MetodosReporteVentaDiario met = new MetodosReporteVentaDiario();
...
//define el icon a tu JFrame
    ...
    private void btncrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncrearActionPerformed
        ...
        if (RestarMeses() > 1) {
            JOptionPane.showMessageDialog(null, "Solo Puede Seleccionar un Plazo de 1 Mes", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteVentaDiario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReporteVentaDiario().setVisible(true);
            }
        });
    }
