...
import Metodos.MetodosVentasMayoreotodo;
 ...
 * @author usuario
 */
public class frmReporteVentasMayoreoTodo extends javax.swing.JFrame {

    /**
     * Creates new form frmReporteDepartamento
     */
    Metodos.MetodosVentasMayoreotodo met = new MetodosVentasMayoreotodo();
    ...
    public frmReporteVentasMayoreoTodo() {
        initComponents();
...
//         }
    ...
    private void initComponents() {
        ...
        setTitle("Reporte Ventas Mayoreo");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(jdcfinal, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
                .addGap(31, 31, 31))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteVentasMayoreoTodo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReporteVentasMayoreoTodo().setVisible(true);
            }
        });
    }
