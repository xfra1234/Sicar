...
public class frmReporteResurtidoesteaño extends javax.swing.JFrame {
    ...
    int sucursal;
    Metodos.MetodosResurtidoesteaño met= new MetodosResurtidoesteaño();
    public frmReporteResurtidoesteaño() {
        initComponents();
...
////////////// Obtener fechas 3 meses atras del mismo año
 ...
 //////////////////////// Fin //////////////////////////////////
         ...
         met.sucursales(fecha3mad, fehca1mud,valorsucursal(),Mesnueva);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmReporteResurtidoesteaño.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmReporteResurtidoesteaño().setVisible(true);
            }
        });
    }
